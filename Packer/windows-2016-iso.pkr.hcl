...
/*
    DESCRIPTION:
    Microsoft Windows Server 2016 build definition.
...
locals {
  ...
  iso_paths = {
    content_library = "content-library-00-w01-cl01/Windows2016/windows2016.iso",
    datastore       = "[00-w01-cl01-ds-vsan01] 09fcf666-b62b-a351-bef3-b02628f74490/f86d10a2-a95c-48b1-9e22-206e5129ca0f/Windows_Server_2016_Datacenter_EVAL_en-us_14393_refresh_464cc220-d06a-40e1-ad13-c62f3b708aee.ISO"
  ...
  vm_name_datacenter_core    = "windows-server-2016-datacenter-core-${local.build_version}"
  vm_name_datacenter_desktop = "windows-server-2016-datacenter-dexp-${local.build_version}"
  vm_name_standard_core      = "windows-server-2016-standard-core-${local.build_version}"
  vm_name_standard_desktop   = "windows-server-2016-standard-dexp-${local.build_version}"
  bucket_name                = replace("windows-server-2016", ".", "")
  bucket_description         = "windows server 2016"
}
...
source "vsphere-iso" "windows-server-standard-2016-core" {
  ...
  network_adapters {
    network      = "00-w01-cl01-vds02_corp_10.199.140.0_24_vlan1027"
  ...
  cd_content = {
    "autounattend.xml" = templatefile("${abspath(path.root)}/data/autounattend.pkrtpl.hcl", {
      ...
      vm_inst_os_image     = "Windows Server 2016 SERVERSTANDARDCORE"
...
source "vsphere-iso" "windows-server-standard-2016-dexp" {
...
source "vsphere-iso" "windows-server-datacenter-2016-core" {
  ...
  cd_content = {
    "autounattend.xml" = templatefile("${abspath(path.root)}/data/autounattend.pkrtpl.hcl", {
      ...
      vm_inst_os_language  = "en-US"
      vm_inst_os_keyboard  = "en-US"
      vm_inst_os_image     = "Windows Server 2016 SERVERDATACENTERCORE"
      vm_inst_os_key       = "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX"
      vm_guest_os_language = "en-US"
      vm_guest_os_keyboard = "en-US"
      vm_guest_os_timezone = "UTC"
...
source "vsphere-iso" "windows-server-datacenter-2016-dexp" {
  ...
  cd_content = {
    "autounattend.xml" = templatefile("${abspath(path.root)}/data/autounattend.pkrtpl.hcl", {
      ...
      vm_inst_os_language  = "en-US"
      vm_inst_os_keyboard  = "en-US"
      vm_inst_os_image     = "Windows Server 2016 SERVERDATACENTER"
      vm_inst_os_key       = "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX"
      vm_guest_os_language = "en-US"
      vm_guest_os_keyboard = "en-US"
      vm_guest_os_timezone = "UTC"
