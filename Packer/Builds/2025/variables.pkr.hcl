...
variable "vm_nic_type" {
  type        = string
  description = "The vm nic typ to use."
  default = ""
}
...
variable "vm_guest_os_version_2025" {
  type        = string
  description = "The guest operating system version. Used for naming."
  default     = "2025"
}

variable "vm_guest_os_version_2022" {
  type        = string
  description = "The guest operating system version. Used for naming."
  default     = "2022"
}

variable "vm_guest_os_version_2019" {
  type        = string
  description = "The guest operating system version. Used for naming."
  default     = "2019"
}
...
variable "vm_guest_os_type_2025" {
  type        = string
  description = "The guest operating system type, also know as guestid."
}

variable "vm_guest_os_type_2022" {
  type        = string
  description = "The guest operating system type, also know as guestid."
}

variable "vm_guest_os_type_2019" {
  type        = string
  description = "The guest operating system type, also know as guestid."
}
...
variable "2025_iso_datastore_path" {
  type        = string
  description = "The path on the source vSphere datastore for the 2025 guest operating system ISO."
}

variable "2022_iso_datastore_path" {
  type        = string
  description = "The path on the source vSphere datastore for the guest operating system ISO."
}

variable "2019_iso_datastore_path" {
  type        = string
  description = "The path on the source vSphere datastore for the guest operating system ISO."
}
...
variable "iso_file_2025" {
  type        = string
  description = "The file name of the guest operating system ISO."
}

variable "iso_file_2022" {
  type        = string
  description = "The file name of the guest operating system ISO."
}

variable "iso_file_2019" {
  type        = string
  description = "The file name of the guest operating system ISO."
}
...
variable "iso_content_library_item_2025" {
  type        = string
  description = "The vSphere content library item name for the guest operating system ISO."
}

variable "iso_content_library_item_2022" {
  type        = string
  description = "The vSphere content library item name for the guest operating system ISO."
}

variable "iso_content_library_item_2019" {
  type        = string
  description = "The vSphere content library item name for the guest operating system ISO."
}
