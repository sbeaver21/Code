...
locals { 
    ...
    vm_name_datacenter_dexp     = "windows-server-2025-datacenter-dexp-${local.build_version}"
    vm_name_standard_core       = "windows-server-2025-standard-core-${local.build_version}"
    vm_name_standard_dexp       = "windows-server-2025-standard-dexp-${local.build_version}"
...
source "vsphere-iso" "windows-server-2025-standard-core" {
...
source "vsphere-iso" "windows-server-2025-standard-dexp" {
...
source "vsphere-iso" "windows-server-2025-datacenter-core" {
    # vCenter
    vcenter_server              = var.vsphere_endpoint
    username                    = var.vsphere_username
    password                    = var.vsphere_password
...
source "vsphere-iso" "windows-server-2025-datacenter-dexp" {
    # vCenter
    vcenter_server              = var.vsphere_endpoint
    username                    = var.vsphere_username
    password                    = var.vsphere_password
